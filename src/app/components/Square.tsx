  ...
  return (
    <div className="w-2/6 h-2/6 text-7xl" onClick={handelClick}>
      <div className={`cursor-pointer w-full h-full flex justify-center items-center ${cells[id] === 'circle' && 'text-[#ff6169]'}`}>
        {cells[id] === 'circle' && <Image className="rounded-full" width={100} height={100} src="/o.png" alt="o" /> || cells[id] === 'cross' && <Image className="rounded-full" width={100} height={100} src="/x.avif" alt="x" />}
      </div>
    </div>
  );
};
